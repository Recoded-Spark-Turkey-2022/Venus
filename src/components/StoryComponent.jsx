  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-36 mt-[50px] md:mt-[78px] pb-[24px] mr-[80px] ml-[89px] md:mx-[0px]">
      ...
      <div className='flex-col text-[#ffffff] max-w-[400px] min-h-[140px]'>
        <button  type="button" className='bg-[#FEDB9B] rounded-[3px] text-[12px] text-[#4699C2] font-bold leading-4 tracking-[0.3px] px-[10px] py-[2px] mt-[17px] md:mt-[25px]'>Language</button>
        ...
        <div className='flex mt-[30px] md:mt-10' width={30}>
          ...
          <div>
            <a href="#home" className='mb-[6px] font-bold text-[16px]'>{storyDetails.user.userName}</a>
            <p className='font-light text-[14px] text-[#E9E9E9]'>Refugee in {storyDetails.user.currentUserCountry}</p>
          </div>
        </div>
      </div>
    </div>
