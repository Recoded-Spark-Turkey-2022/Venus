...
{        if (showByCountry === "View All"){
  ...
  return (
    <div className='bg-[#EAFBFF]'>
        <h1 className='text-center text-[48px] font-bold leading-[56px] text-[#025594] pt-[25px] md:pt-[85px]'>{t("About.our-team")}</h1>
        <Container>
         ...
         <TeamMemberCard key={teamMember.id} name={teamMember.name} href={teamMember.linkedin}/>)}
                </div>
